  ...
  return (
    <div className="mx-auto max-w-4xl px-6 py-10">
      ...
      <p className="mt-2 text-muted-foreground">
        Connect GunBroker and WooCommerce on the Connections tab. ShipStation
        still waits for a later build.
      </p>
      ...
      <div className="mt-6">
        ...
        {current === "connections" && gunbroker && woocommerce ? (
          <ConnectionSettings gunbroker={gunbroker} woocommerce={woocommerce} />
        ) : null}
      </div>
    </div>
  );
